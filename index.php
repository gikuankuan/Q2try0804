...
<iframe name="back" style="display:none;">
	
</iframe>
	<div id="all">
		<div style="display: flex;">
    	<div id="title" style="width: 100%;">
		<?php date("m 月 d 號 l") ?> | 今日瀏覽: 1 | 累積瀏覽: 36    
		
		</div>
		<a href="index.php">
		<div id="title3" style="width: 100%;">
			回首頁
		</div>
		</a>
		</div>
        ...
        <div id="mm">
            ...
            <div class="hal" id="main">
            	<div>
            		<marquee style="width: 80%;float:left; " >
						請民眾踴躍投稿電子報，讓電子報成為大家相互交流，分享的園地!詳見最新文章。
					</marquee>
					<span style="width:20%; display:inline-block;margin:auto">
							<?php
								if(!empty($_SESSION['login'])){
									echo "歡迎".$_SESSION['login'];
									if($_SESSION['login']=='admin'){
										echo "<a href='admin.php?do=main;'>管理</a>|";
